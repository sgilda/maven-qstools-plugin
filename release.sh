...
EMAIL_SUBJECT="\${RELEASEVERSION} of QSTools released"
# EAP team email To ?
...
notify_email()
{
   echo "***** Performing QSTools release notifications"
...
release()
{
   echo "Releasing QSTools version $RELEASEVERSION"
